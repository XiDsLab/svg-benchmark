...
bcounts[,"region"]<-as.factor(data[["anno_coord"]][["layer_guess_reordered_short"]][eindex])
...
p_adjusted<-p.adjust(as.vector(p_combined), method = "BH")
